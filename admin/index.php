...
<body>
  ...
  <div class="container-scroller">
    ...
    <!-- header.php contains partial:partials/_navbar.html, partial -->
    <?php include './assets/header.php' ?>

    <div class="container-fluid page-body-wrapper">

      <!-- removed:partials/_settings-panel.html -->
      <?php //include './assets/settings_panel.php' ?>


      <!-- removed right-sidebar here -->
      <?php //include './assets/right-sidebar.php' ?>
      
      <!-- partial -->
      
      <!-- sidebar.php contains partial:partials/_sidebar.html, partial -->
      ...
      <div class="main-panel">
        ...
        <!-- footer.php contains partial:partials/_footer.html -->
  ...
  <!-- script.php contains base:js to End custom js for this page -->
