...
<body>
                ...
                <div class="container-fluid p-0">
                    <div class="row align-items-center justify-content-between no-gutters">
                        <div class="col-xl-2 col-lg-2">
                            <div class="logo-img">
                                <a href="index.php">
                                    <img src="img/logo1.png" width="200" height="100" alt="">
    ...
    <div class="slider_area ">
        <div class="slider_area_inner d-flex align-items-center" style="background-image: url(img/logo2.png);">
            <div class="container">
                <div class="row">
                    <div class="col-xl-7">
                        <div class="single_slider">
                            <div class="slider_text">
                                ...
                                <a href="#" class="boxed-btn4 ">Find Lawyers</a>
                            </div>
                        </div>
                    </div>
                </div>
